...
// Social icons section panel
		$wp_customize->add_section( 'coral_drive_social_icons_section', array(
			'title' 			=> __( 'Social icons', 'coral-drive' ),
			'priority'			=> 28,
			'description' => __( 'Type the target URL (with http://) if you need a social icon in the footer, remove it if you do not need it!', 'coral-drive' ),
		) );
		$wp_customize->add_setting( 'coral_drive_youtube_url_setting' , array(
			'default'           => '',
			'transport'         => 'refresh',
			'sanitize_callback' => 'esc_url_raw',
		));
		$wp_customize->add_control( new Coral_Drive_Text_Description_Control( $wp_customize, 'coral_drive_youtube_url_control', array(
			'label' 			=> __( 'Youtube URL (start with http://)', 'coral-drive' ),
			'section' 			=> 'coral_drive_social_icons_section',
			'settings' 			=> 'coral_drive_youtube_url_setting',
			'priority' 			=> 14,
		) ) );	
		$wp_customize->add_setting( 'coral_drive_feed_url_setting' , array(
			'default'           => '',
			'transport'         => 'refresh',
			'sanitize_callback' => 'esc_url_raw',
		));
		$wp_customize->add_control( new Coral_Drive_Text_Description_Control( $wp_customize, 'coral_drive_feed_url_control', array(
			'label' 			=> __( 'Feed URL (start with http://)', 'coral-drive' ),
			'section' 			=> 'coral_drive_social_icons_section',
			'settings' 			=> 'coral_drive_feed_url_setting',
			'priority' 			=> 16,
		) ) );		
		$wp_customize->add_setting( 'coral_drive_twitter_url_setting' , array(
			'default'           => '',
			'transport'         => 'refresh',
			'sanitize_callback' => 'esc_url_raw',
		));
		$wp_customize->add_control( new Coral_Drive_Text_Description_Control( $wp_customize, 'coral_drive_twitter_url_control', array(
			'label' 			=> __( 'Twitter URL (start with http://)', 'coral-drive' ),
			'section' 			=> 'coral_drive_social_icons_section',
			'settings' 			=> 'coral_drive_twitter_url_setting',
			'priority' 			=> 18,
		) ) );
		$wp_customize->add_setting( 'coral_drive_google_url_setting' , array(
			'default'           => '',
			'transport'         => 'refresh',
			'sanitize_callback' => 'esc_url_raw',
		));
		$wp_customize->add_control( new Coral_Drive_Text_Description_Control( $wp_customize, 'coral_drive_google_url_control', array(
			'label' 			=> __( 'Google URL (start with http://)', 'coral-drive' ),
			'section' 			=> 'coral_drive_social_icons_section',
			'settings' 			=> 'coral_drive_google_url_setting',
			'priority' 			=> 20,
		) ) );		
		$wp_customize->add_setting( 'coral_drive_facebook_url_setting' , array(
			'default'           => '',
			'transport'         => 'refresh',
			'sanitize_callback' => 'esc_url_raw',
		));
		$wp_customize->add_control( new Coral_Drive_Text_Description_Control( $wp_customize, 'coral_drive_facebook_url_control', array(
			'label' 			=> __( 'Facebook URL (start with http://)', 'coral-drive' ),
			'section' 			=> 'coral_drive_social_icons_section',
			'settings' 			=> 'coral_drive_facebook_url_setting',
			'priority' 			=> 22,
		) ) );	
